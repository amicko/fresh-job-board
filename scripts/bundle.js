...
module.exports = React.createClass({
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(FirstBox, null)
		);
	}
});

},{"./firstBoxComponent.js":159,"./formComponent.js":160,"./navComponent.js":163,"react":156}],158:[function(require,module,exports){
"use strict";
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				...
				" because the majority of candidates search for availablepositions using keywords, make sure you use all relevant keywords in your posting."
			),
			React.createElement(
				"p",
				null,
			...
			React.createElement(
				...
				" Do not limit your job posting to a restricted area around the job's location. Make sure to include surrounding cities and metropolitan areas in your circle."
			),
			React.createElement(
				"p",
				null,
				...
				" Even though you may not want to give an exact compensation, give a range. Make sure to point out any bonuses, commisions, or non-monetary compensation, as well."
			)
		);
	}
});
...
module.exports = React.createClass({
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement(
				"div",
				{ className: "descriptionSnip" },
				"Lots and lots of words regarding saomething that I am sure is very important but hasnt actyally been pulled from a server just yet."
			),
			React.createElement(
				"ul",
				{ className: "tagLine" },
...
module.exports = React.createClass({
	...
	render: function render() {
		return React.createElement(
			...
			React.createElement("div", { className: "topGreyBox" }),
			React.createElement(
				"div",
				{ className: "navBar" },
				React.createElement("a", { href: "#home", className: "navLogo" }),
				React.createElement(
					"div",
					{ className: "logoTitle" },
					"Fresh Jobs"
...
},{"./components/appComponent.js":157,"./components/filterBoxComponent.js":158,"./components/firstBoxComponent.js":159,"./components/formComponent.js":160,"./components/informationBoxComponent.js":161,"./components/jobRowComponent.js":162,"./components/navComponent.js":163,"react":156}]},{},[164])
